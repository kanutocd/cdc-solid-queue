...
Gem::Specification.new do |spec|
  ...
  spec.homepage = 'https://kanutocd.github.io/cdc-solid-queue/'
  spec.license = 'MIT'
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/kanutocd/cdc-solid-queue'
  spec.metadata['changelog_uri'] = "#{spec.metadata['source_code_uri']}/blob/main/CHANGELOG.md"
  spec.metadata['rubygems_mfa_required'] = 'true'

  spec.files = Dir.chdir(__dir__) do
    Dir['lib/**/*.rb', 'lib/**/*.rake', 'sig/**/*.rbs', 'docs/**/*.md', 'README.md', 'CHANGELOG.md', 'LICENSE.txt']
  end
